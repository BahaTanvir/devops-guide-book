...
1. **Foundations** — Core DevOps practices including deployments, logging, environments, and CI/CD
2. **Infrastructure as Code** — Mastering Terraform, managing state, modules, and cost control
3. **Container Orchestration** — Deep dive into Kubernetes, from basics to production patterns
4. **Observability and Reliability** — Monitoring, alerting, tracing, SLOs, and debugging
5. **Security and Compliance** — Container security, secrets management, access control, and compliance
6. **CI/CD Mastery** — Advanced pipeline patterns, testing strategies, and GitOps
...
[Continue to About Sarah →](./about-sarah.md)
